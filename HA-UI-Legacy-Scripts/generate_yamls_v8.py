...
def generate_yaml_v8():
    ...
    yaml_out = """title: "GT RACING COCKPIT V8"
theme: default
...
"""
    ...
    with open("c:/Users/zhong/Downloads/Compressed/files/HA-UI/ha_cyber_ui_v8.yaml", "w", encoding="utf-8") as f:
        f.write(yaml_out)
        print("Generated ha_cyber_ui_v8.yaml (Ultra-Wide Graphics Update)!")
