...
def generate_yaml_v11():
    ...
    yaml_out = """title: "GT RACING COCKPIT V11"
theme: default
...
"""
        # ==========================================
        # 1. SWITCHES (Strictly 5 columns - Align Top Strict)
        # ==========================================
        if data.get("switches"):
            yaml_out += f"""                    - type: custom:button-card
                    ...
                    - type: grid
                      columns: 5 
                      card_mod:
                        # FIXED: This CSS ensures that if the container stretches, the rows stay compacted at the top instead of spacing out!
                        style: |
                          div#root {{ 
                            gap: 12px !important; 
...
"""
    ...
    with open("c:/Users/zhong/Downloads/Compressed/files/HA-UI/ha_cyber_ui_v11.yaml", "w", encoding="utf-8") as f:
        f.write(yaml_out)
        print("Generated ha_cyber_ui_v11.yaml (V8 Heights + Explicit Row Clamping)!")
