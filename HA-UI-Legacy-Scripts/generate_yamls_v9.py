...
def generate_yaml_v9():
    ...
    yaml_out = """title: "GT RACING COCKPIT V9"
theme: default
...
button_card_templates:
  ...
  racing_gear_nav:
    ...
    styles:
      card:
        - height: "45px" # 进一步压缩左侧导航栏高度，避免主卧跑到屏幕外面
  ...
  cyber_racing_title:
    ...
    styles:
      card:
        ...
        - padding: "2px 20px"
        - margin: "15px 0 8px 0" # 压缩分类标题的上下间距
        - border-radius: "0"
        - box-shadow: "none"
        - height: "30px"
            ...
            cards:
              - type: custom:button-card
                ...
                styles:
                  ...
                  name: [color: "#ff1030", font-weight: "900", font-style: "italic", letter-spacing: "3px", font-size: "16px", margin-top: "5px"]
                  icon: [color: "#ff1030", width: "40px", filter: "drop-shadow(0 0 10px #ff1030)"]
"""
    ...
    yaml_out += """
          ...
          - type: vertical-stack
            ...
            card_mod:
              style: |
                ha-card, div { 
                   padding: 15px 3% !important; /* 使左右边距柔和且绝对不会超出去 */
...
"""
        # ==========================================
        # 1. SWITCHES (Strictly 5 columns as requested)
        # ==========================================
        if data.get("switches"):
            yaml_out += f"""                    - type: custom:button-card
                    ...
                    - type: grid
                      columns: 5 # 强制使用完美的 5 列布局，杜绝横向撑暴或溢出
                      card_mod:
                        style: |
...
"""
    ...
    with open("c:/Users/zhong/Downloads/Compressed/files/HA-UI/ha_cyber_ui_v9.yaml", "w", encoding="utf-8") as f:
        f.write(yaml_out)
        print("Generated ha_cyber_ui_v9.yaml (Absolute 5-Col Strict Single-Page Override)!")
