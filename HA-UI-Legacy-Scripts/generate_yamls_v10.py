...
def generate_yaml_v10():
    ...
    yaml_out = """title: "GT RACING COCKPIT V10"
theme: default
...
button_card_templates:
  ...
  racing_gear_nav:
    ...
    styles:
      card:
        - height: "55px" # 【回滚】恢复V8时的高敞高度
        - background: "rgba(10, 10, 12, 0.7)"
        - border-left: "3px solid transparent"
        - clip-path: "polygon(0 0, 95% 0%, 100% 100%, 5% 100%)"
        - margin-bottom: "10px" # 【回滚】恢复V8导航栏间距
        - padding: "0"
  ...
  cyber_racing_title:
    ...
    styles:
      card:
        ...
        - padding: "2px 20px"
        - margin: "25px 0 12px 0" # 【回滚】恢复V8舒展的标题外边距
        - border-radius: "0"
        - box-shadow: "none"
        - height: "35px" # 【回滚】恢复V8标题栏高度
            ...
            card_mod:
              style: |
                ha-card, div { 
                  ...
                  padding: 15px 10px !important; /* 回滚左侧大边距 */
                }
            cards:
    ...
    yaml_out += """
          ...
          - type: vertical-stack
            ...
            card_mod:
              style: |
                ha-card, div { 
                   padding: 20px 3% !important; /* 回滚右侧顶部的舒适边距 */
                   box-sizing: border-box !important;
                   width: 100%;
                   max-height: 100vh;
                   overflow: visible !important; /* 允许滚动条以备不测，如果太长就滚动，不再强制切断内容 */
                }
            cards:
"""
...
"""
        # ==========================================
        # 1. SWITCHES (Strictly 5 columns - Kept from V9)
        # ==========================================
        if data.get("switches"):
            yaml_out += f"""                    - type: custom:button-card
                    ...
                    - type: grid
                      columns: 5 # 保持 V9 的 5 列限制
                      card_mod:
                        style: |
                          div#root {{ gap: 12px !important; }} # 回滚到舒适的列间距
                      cards:
"""
...
"""
    ...
    with open("c:/Users/zhong/Downloads/Compressed/files/HA-UI/ha_cyber_ui_v10.yaml", "w", encoding="utf-8") as f:
        f.write(yaml_out)
        print("Generated ha_cyber_ui_v10.yaml (V8 Spacing + V9 5-Col Bindings)!")
