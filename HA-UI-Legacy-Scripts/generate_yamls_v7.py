...
def generate_yaml_v7():
    ...
    yaml_out = """title: "GT RACING COCKPIT V7"
theme: default
background: "no-repeat center center / cover url('https://w.wallhaven.cc/full/qd/wallhaven-qd9rm5.png')"

button_card_templates:
  # ==========================================
  # [RACING GEAR SHIFT] - The Room Nav Buttons FIX: named racing_gear_nav as used
  # ==========================================
  racing_gear_nav:
    show_name: true
    show_icon: true
  ...
  # ==========================================
  # [CYBER TITLE] - For Section Headers
  # ==========================================
  cyber_title:
    show_name: true
    show_icon: false
    styles:
      card:
        ...
        - border-left: "8px solid var(--primary-neon)"
        - padding: "6px 15px"
...
views:
  - path: default_view
    ...
    panel: true # Enable panel mode for full width HUD
    cards:
            ...
            card_mod:
              style: |
                ha-card, div { 
                   ...
                   max-width: 100% !important; /* Force take up all available horizontal space */
                   height: 100%;
...
"""
    ...
    # Neon colors configuration with matching RGB values to power the box-shadows
    neon_configs = [
...
"""
        # ==========================================
        # 1. SWITCHES (Racing Mechanical Switches)
        # ==========================================
        if data.get("switches"):
            yaml_out += f"""                    - type: custom:button-card
                      template: cyber_title
                      name: "CIRCUITS // MODULE"
                    # CSS Grid using Custom Layout Card for AUTO-FIT based on width! No more forced stretching.
                    - type: custom:layout-card
                      layout_type: custom:grid-layout
                      layout:
...
"""
        ...
        # ==========================================
        # 2. MEDIA & CLIMATES (Heavy Engines)
        # ==========================================
...
"""
        ...
        # ==========================================
        # 3. LIGHTS AND COVERS (Illumination Array)
        # ==========================================
...
"""
    ...
    with open("c:/Users/zhong/Downloads/Compressed/files/HA-UI/ha_cyber_ui_v7.yaml", "w", encoding="utf-8") as f:
        f.write(yaml_out)
        print("Generated ha_cyber_ui_v7.yaml (ULTIMATE F1 COCKPIT)!")
